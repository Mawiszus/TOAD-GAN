# Code from https://github.com/mcgreentn/GDMC
...
def load_string(ctx):
    ...
    value = str(data[2:string_len + 2])[2:-1]
...
for c in (
TAG_Byte, TAG_Short, TAG_Int, TAG_Float, TAG_Double, TAG_String, TAG_Byte_Array, TAG_List, TAG_Compound,
