...
from zelda.tokens import TOKEN_DOWNSAMPLING_HIERARCHY as HIERARCHY


def special_zelda_downsampling(num_scales, scales, image, token_list):
    """
    Special Downsampling Method designed for The Legend of Zelda Token based levels.
